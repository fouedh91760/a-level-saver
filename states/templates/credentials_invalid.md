...
**Si vous ne trouvez pas cet email :**
- Vérifiez dans vos **spams/courriers indésirables**
- Vérifiez l'adresse email que vous avez utilisée lors de l'inscription

Une fois retrouvés, merci de nous les transmettre par retour d'email afin que nous puissions finaliser votre inscription.
<!-- /BLOCK -->

<!-- BLOCK: warning_spam -->
**Important :** L'email contenant vos identifiants peut se trouver dans vos spams. Pensez à vérifier ce dossier.
<!-- /BLOCK -->
