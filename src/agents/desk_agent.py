...
"""
    ...
    def process(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        prompt = """Analyze this support ticket and provide your recommendations.

Please consider:
- The nature of the student's question or concern
- The appropriate response that would be helpful and accurate
- The suggested status and priority
