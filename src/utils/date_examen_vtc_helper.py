...
# Mapping ville → département (préfecture ou ville principale → code département)
CITY_TO_DEPT = {
    # Île-de-France
    'paris': '75', 'boulogne': '92', 'boulogne-billancourt': '92',
    'nanterre': '92', 'versailles': '78', 'saint-denis': '93',
    'bobigny': '93', 'créteil': '94', 'creteil': '94', 'montreuil': '93',
    'argenteuil': '95', 'cergy': '95', 'pontoise': '95', 'evry': '91',
    'melun': '77',
    # PACA
    'marseille': '13', 'aix-en-provence': '13', 'aix': '13',
    'nice': '06', 'cannes': '06', 'antibes': '06', 'grasse': '06',
    'toulon': '83', 'avignon': '84', 'digne': '04', 'gap': '05',
    # Occitanie
    'toulouse': '31', 'montpellier': '34', 'nîmes': '30', 'nimes': '30',
    'perpignan': '66', 'béziers': '34', 'beziers': '34', 'carcassonne': '11',
    'tarbes': '65', 'albi': '81', 'rodez': '12', 'cahors': '46',
    'montauban': '82', 'auch': '32', 'foix': '09', 'mende': '48',
    # Auvergne-Rhône-Alpes
    'lyon': '69', 'grenoble': '38', 'saint-etienne': '42', 'st-etienne': '42',
    'clermont-ferrand': '63', 'annecy': '74', 'chambéry': '73', 'chambery': '73',
    'valence': '26', 'privas': '07', 'bourg-en-bresse': '01', 'aurillac': '15',
    'le puy': '43', 'moulins': '03',
    # Nouvelle-Aquitaine
    'bordeaux': '33', 'limoges': '87', 'poitiers': '86', 'la rochelle': '17',
    'pau': '64', 'bayonne': '64', 'biarritz': '64', 'angoulême': '16', 'angouleme': '16',
    'périgueux': '24', 'perigueux': '24', 'agen': '47', 'mont-de-marsan': '40',
    'niort': '79', 'tulle': '19', 'guéret': '23', 'gueret': '23',
    # Grand Est
    'strasbourg': '67', 'metz': '57', 'nancy': '54', 'reims': '51',
    'mulhouse': '68', 'colmar': '68', 'troyes': '10', 'châlons': '51',
    'charleville-mézières': '08', 'épinal': '88', 'epinal': '88',
    'bar-le-duc': '55', 'chaumont': '52',
    # Hauts-de-France
    'lille': '59', 'amiens': '80', 'arras': '62', 'beauvais': '60',
    'laon': '02', 'roubaix': '59', 'tourcoing': '59', 'dunkerque': '59',
    'calais': '62', 'boulogne-sur-mer': '62', 'saint-quentin': '02',
    # Bretagne
    'rennes': '35', 'brest': '29', 'quimper': '29', 'lorient': '56',
    'vannes': '56', 'saint-brieuc': '22', 'st-brieuc': '22',
    # Normandie
    'rouen': '76', 'le havre': '76', 'caen': '14', 'cherbourg': '50',
    'évreux': '27', 'evreux': '27', 'alençon': '61', 'alencon': '61',
    # Pays de la Loire
    'nantes': '44', 'angers': '49', 'le mans': '72', 'laval': '53',
    'la roche-sur-yon': '85', 'saint-nazaire': '44',
    # Centre-Val de Loire
    'orléans': '45', 'orleans': '45', 'tours': '37', 'bourges': '18',
    'chartres': '28', 'blois': '41', 'châteauroux': '36', 'chateauroux': '36',
    # Bourgogne-Franche-Comté
    'dijon': '21', 'besançon': '25', 'besancon': '25', 'auxerre': '89',
    'belfort': '90', 'nevers': '58', 'mâcon': '71', 'macon': '71',
    'vesoul': '70', 'lons-le-saunier': '39',
    # Corse
    'ajaccio': '2A', 'bastia': '2B',
}

def normalize_location_to_dept(location: str) -> Optional[str]:
    """
    Normalise une location (ville ou département) vers un code département.

    Args:
        location: Nom de ville, code département, ou nom de département

    Returns:
        Code département (ex: "34") ou None si non trouvé
    """
    if not location:
        return None
    ...
    # Si c'est déjà un code département (2 chiffres ou 2A/2B)
    if location_clean.isdigit() and len(location_clean) == 2:
        return location_clean
    if location_clean.upper() in ('2A', '2B'):
        return location_clean.upper()

    # Chercher dans le mapping ville → département
    location_lower = location_clean.lower()
    if location_lower in CITY_TO_DEPT:
        dept = CITY_TO_DEPT[location_lower]
        logger.debug(f"  Normalisation: '{location}' -> département {dept}")
        return dept

    # Chercher si la location contient une ville connue
    for city, dept in CITY_TO_DEPT.items():
        if city in location_lower:
            logger.debug(f"  Normalisation partielle: '{location}' contient '{city}' -> département {dept}")
            return dept

    logger.debug(f"  Normalisation: '{location}' non reconnu")
    return None
